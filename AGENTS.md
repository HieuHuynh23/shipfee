...
This project is indexed by GitNexus as **shipfee** (2223 symbols, 3787 relationships, 197 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
